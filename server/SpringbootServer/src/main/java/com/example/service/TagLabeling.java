...
public class TagLabeling {
    private static final Logger logger = LoggerFactory.getLogger(TagLabeling.class);
...
//    요청 문장 태깅 메서드
    public String sentenceTagging(String text) {
        logger.info("Starting sentenceTagging for text: {}", text);
        ...
        logger.warn("Label not found in the response or response is null");
