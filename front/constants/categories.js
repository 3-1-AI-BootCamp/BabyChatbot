// 아기용품 리스트로, 1차로 이 리스트 내 값이 있는지를 검사
export const categories = {
    ...
    기저귀용품: [
      "기저귀", "아기용물티슈", "기저귀케이크", "기저귀가방", "기저귀정리함", "기저귀갈이대",
    ...
    목욕스킨케어: [
      ...
      "아기샴푸거품기", "유아용목욕가운", "베이비목욕바구니", "목욕물놀이장난감", "아기목욕물컵",
    ...
    안전용품: [
      ...
      "아기손보호대", "유아가전안전장치", "아기욕조안전매트", "아기침대보호기", "유아가구보호대", "유아용체온계","아기 발 보호대"
    ],
}
